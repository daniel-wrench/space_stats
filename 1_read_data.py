...
psp_data = data_import.read_cdfs([
    ...
    "data_raw/psp/psp_fld_l2_mag_rtn_2018111112_v01.cdf", #clean up to here AFTER 0.02S RESAMPLING
    ...
    "data_raw/psp/psp_fld_l2_mag_rtn_2018111718_v01.cdf" #clean up to here AFTER 0.75S RESAMPLING
##    #MISSING DATA HERE
...
psp_df.to_pickle("data_processed/psp/psp_df.pkl")
