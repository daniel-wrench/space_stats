...
np.save(file = 'data_processed/psp/psp_clean_inputs_train', arr = psp_clean_inputs_train)
np.save(file = 'data_processed/psp/psp_clean_outputs_train', arr = psp_clean_outputs_train)

np.save(file = 'data_processed/psp/psp_gapped_inputs_train', arr = psp_gapped_inputs_train)
np.save(file = 'data_processed/psp/psp_gapped_outputs_train', arr = psp_gapped_outputs_train)

np.save(file = 'data_processed/psp/psp_filled_inputs_train', arr = psp_filled_inputs_train)
np.save(file = 'data_processed/psp/psp_filled_inputs_train_flat', arr = psp_filled_inputs_train_flat)
np.save(file = 'data_processed/psp/psp_filled_inputs_train_flat_no_ind', arr = psp_filled_inputs_train_flat_no_ind)
np.save(file = 'data_processed/psp/psp_filled_outputs_train', arr = psp_filled_outputs_train)

np.save(file = 'data_processed/psp/psp_lint_inputs_train', arr = psp_lint_inputs_train)
np.save(file = 'data_processed/psp/psp_lint_inputs_train_flat', arr = psp_lint_inputs_train_flat)
np.save(file = 'data_processed/psp/psp_lint_inputs_train_flat_no_ind', arr = psp_lint_inputs_train_flat_no_ind)
np.save(file = 'data_processed/psp/psp_lint_outputs_train', arr = psp_lint_outputs_train)
...
np.save(file = 'data_processed/psp/psp_clean_inputs_test', arr = psp_clean_inputs_test)
np.save(file = 'data_processed/psp/psp_clean_outputs_test', arr = psp_clean_outputs_test)

np.save(file = 'data_processed/psp/psp_gapped_inputs_test', arr = psp_gapped_inputs_test)
np.save(file = 'data_processed/psp/psp_gapped_outputs_test', arr = psp_gapped_outputs_test)

np.save(file = 'data_processed/psp/psp_filled_inputs_test', arr = psp_filled_inputs_test)
np.save(file = 'data_processed/psp/psp_filled_inputs_test_flat', arr = psp_filled_inputs_test_flat)
np.save(file = 'data_processed/psp/psp_filled_inputs_test_flat_no_ind', arr = psp_filled_inputs_test_flat_no_ind)
np.save(file = 'data_processed/psp/psp_filled_outputs_test', arr = psp_filled_outputs_test)

np.save(file = 'data_processed/psp/psp_lint_inputs_test', arr = psp_lint_inputs_test)
np.save(file = 'data_processed/psp/psp_lint_inputs_test_flat', arr = psp_lint_inputs_test_flat)
np.save(file = 'data_processed/psp/psp_lint_inputs_test_flat_no_ind', arr = psp_lint_inputs_test_flat_no_ind)
np.save(file = 'data_processed/psp/psp_lint_outputs_test', arr = psp_lint_outputs_test)
...
np.save(file = 'data_processed/mms/mms_clean_inputs_test', arr = mms_clean_inputs_test)
np.save(file = 'data_processed/mms/mms_clean_outputs_test', arr = mms_clean_outputs_test)
np.save(file = 'data_processed/mms/mms_gapped_inputs_test', arr = mms_gapped_inputs_test)
np.save(file = 'data_processed/mms/mms_gapped_outputs_test', arr = mms_gapped_outputs_test)

np.save(file = 'data_processed/mms/mms_filled_inputs_test', arr = mms_filled_inputs_test)
np.save(file = 'data_processed/mms/mms_filled_inputs_test_flat', arr = mms_filled_inputs_test_flat)
np.save(file = 'data_processed/mms/mms_filled_inputs_test_flat_no_ind', arr = mms_filled_inputs_test_flat_no_ind)
np.save(file = 'data_processed/mms/mms_filled_outputs_test', arr = mms_filled_outputs_test)

np.save(file = 'data_processed/mms/mms_lint_inputs_test', arr = mms_lint_inputs_test)
np.save(file = 'data_processed/mms/mms_lint_inputs_test_flat', arr = mms_lint_inputs_test_flat)
np.save(file = 'data_processed/mms/mms_lint_inputs_test_flat_no_ind', arr = mms_lint_inputs_test_flat_no_ind)
np.save(file = 'data_processed/mms/mms_lint_outputs_test', arr = mms_lint_outputs_test)

np.save(file = 'data_processed/mms/mms_gapped_inputs_test_prop_removed', arr = mms_gapped_inputs_test_prop_removed)
